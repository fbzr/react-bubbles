...
- [ ] Explain what a token is used for.
  ...
  - A token is used to protect private pages that require login.

- [ ] What steps can you take in your web apps to keep your data secure?

  - You can create an authentication middleware and private routes to check users privileges.

- [ ] Describe how web servers work.

  - Web servers store code for different websites. They receive requests through a Url and retrieve the right information/code to the requester.
